/**
 * Poll-loop guard backing this plugin's SSE change stream: one bounded refresh
 * loop that never overlaps itself, backs off on consecutive failures, and stops
 * at a global deadline. Pure logic with injectable timers, so consumers test it
 * without wall clocks.
 */
